...
import { useFrontmatterStore, SPECIAL_KEYS } from '../../editor/frontmatter-store';
import { PropertyValueEditor } from '../../editor/PropertyValueEditor';
import { TitleEditor, TagsEditor, AliasesEditor } from '../../editor/SpecialPropertyEditors';
import type { NoteDto } from '@notesaner/contracts';
import type { FrontmatterProperty, FrontmatterValueType } from '../../editor/frontmatter-parser';
...
export function PropertiesPanel({
  ...
  // Hydrate store when note changes or content loads
  useEffect(() => {
