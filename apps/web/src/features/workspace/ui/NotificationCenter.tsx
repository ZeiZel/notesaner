...
export function NotificationCenter({
  ...
  // Effect: data loading on mount/filter change via Zustand store action.
  // TODO: migrate to TanStack Query for notification fetching.
  useEffect(() => {
    if (accessToken) {
  ...
  // Effect: keyboard event listener for Escape key (valid DOM side effect)
  useEffect(() => {
  ...
  // Effect: outside-click listener for panel dismissal (valid DOM side effect)
  useEffect(() => {
