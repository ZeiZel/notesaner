...
// NOTE: UI state, kept in Zustand for persistence. The `isExpanded` field is
// persisted to localStorage so the ribbon collapse/expand state survives
// page reloads — an expected user experience. `activeAction` is transient
// and excluded from persistence via `partialize`.
// ---------------------------------------------------------------------------
