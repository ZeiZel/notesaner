...
export function ExportDialog({ open, onClose, noteId, noteIds, noteTitle }: ExportDialogProps) {
  ...
  const handleClose = useCallback(() => {
    if (downloadState === 'downloading') return; // Don't close while downloading
    onClose();
  ...
  return (
    ...
    >
      ...
      >
        ...
        {errorMessage && (
          <div
            className="mx-6 mb-2 rounded-md px-4 py-3 text-sm"
            style={{
        ...
        <div
          ...
          style={{ borderColor: 'var(--ns-color-border, #e5e5e5)' }}
        >
          <span className="text-xs" style={{ color: 'var(--ns-color-foreground-muted, #666)' }}>
            {isBatchMode
              ...
              style={{
                ...
                backgroundColor:
                  downloadState === 'complete'
                    ? 'var(--ns-color-success, #16a34a)'
                    : 'var(--ns-color-primary, #2563eb)',
                opacity: downloadState === 'downloading' || downloadState === 'complete' ? 0.8 : 1,
              }}
            >
              {downloadState === 'idle' && (
                <>
