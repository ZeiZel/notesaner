// NOTE: Business store — editor mode is a core domain concept with persistence.
// Mode (wysiwyg/source/preview/reading) and reading settings are persisted to
// localStorage so the user's preferred editing mode is remembered. The `markdown`
// field is transient and correctly excluded from persistence via `partialize`.
/**
