...
import { useEditorModeStore, EDITOR_MODE_LABELS, type EditorMode } from './editor-mode-store';
  ...
  return (
    ...
    >
      ...
      <button
        ...
        title={`${EDITOR_MODE_LABELS[mode]} (Cmd+E)`}
        ...
        style={{
          ...
          backgroundColor: !isReading ? 'var(--ns-color-secondary)' : 'transparent',
        }}
      >
      ...
      <button
        ...
        style={{
          color: isReading ? 'var(--ns-color-primary)' : 'var(--ns-color-foreground-muted)',
          backgroundColor: isReading ? 'var(--ns-color-primary-muted)' : 'transparent',
        }}
      >
