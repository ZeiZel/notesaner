...
export function SettingsLayout({ children }: SettingsLayoutProps) {
  ...
  // TODO: migrate to TanStack Query for workspace settings fetching.
  useEffect(() => {
  ...
  // Effect: RBAC guard -- redirect non-admin users after role check.
  // This is a navigation side effect that cannot be expressed as derived state.
  useEffect(() => {
