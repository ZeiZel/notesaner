...
import { PublicNavigation } from '@/features/publish';
import { PublicSidebar, type PublicNoteTreeNode } from '@/features/publish';
...
export function PublicVaultShell({ slug, children }: PublicVaultShellProps) {
  ...
  const currentPath = pathname ? extractNotePath(pathname, slug) : undefined;
