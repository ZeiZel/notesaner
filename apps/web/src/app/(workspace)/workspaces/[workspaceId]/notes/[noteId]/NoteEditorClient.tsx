...
/**
 * NoteEditorClient — client component that composes the editor toolbar with
...
import { EditorModeToggle } from '@/features/editor/EditorModeToggle';
import { EditorModeWrapper } from '@/features/editor/EditorModeWrapper';
