  ...
  return (
    <form action={formAction} noValidate className="space-y-4">
      {state.errors?.general && (
        <div role="alert" className="rounded-md bg-destructive-muted px-3 py-2 text-sm text-destructive">
          {state.errors.general}
        </div>
      )}
      ...
      <div className="space-y-1.5">
        ...
        {state.errors?.displayName && (
          <p role="alert" className="text-xs text-destructive">{state.errors.displayName}</p>
        )}
      </div>
      ...
      <div className="space-y-1.5">
        ...
        {state.errors?.password && (
          <p role="alert" className="text-xs text-destructive">{state.errors.password}</p>
        )}
      </div>
